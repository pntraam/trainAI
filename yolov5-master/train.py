...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "/Users/ngoctram/Downloads/trainAI/yolov5-master/runs/train/exp5/weights/best.pt", help="initial weights path")
